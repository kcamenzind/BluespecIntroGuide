...
- [Intro Bluespec User Guide](#intro-bluespec-user-guide)
  * [Overview](#overview)
  ...
  * [Bluespec Variables, Types, and Operators](#bluespec-variables-types-and-operators)
    + [Data Types](#data-types)
      ...
      - [Type conversions](#type-conversions)
        * [Converting between numeric types, Integers, and Bits](#converting-between-numeric-types-integers-and-bits)
        * [Converting between Bits and other types](#converting-between-bits-and-other-types)
      - [Working with Bits](#working-with-bits)
        * [Indexing Bits](#indexing-bits)
        * [Concatenating Bits](#concatenating-bits)
        * [Extending Bits](#extending-bits)
        * [Truncating Bits](#truncating-bits)
    + [Operators](#operators)
  ...
  * [Sequential Circuits](#sequential-circuits)
    + [Interfaces](#interfaces)
      - [Method Types](#method-types)
        ...
        * [ActionValue Methods](#actionvalue-methods)
      - [Empty Interface](#empty-interface)
    + [Modules](#modules)
      - [Module Declaration](#module-declaration)
      - [Internal State](#internal-state)
        * [Instantiating Internal State](#instantiating-internal-state)
        * [Registers](#registers)
        * [Vectors](#vectors)
      - [Methods and Rules](#methods-and-rules)
        * [Methods](#methods)
        * [Rules](#rules)
        * [Avoiding Double Writes](#avoiding-double-writes)
  * [Additional/Advanced Topics (TODO)](#additionaladvanced-topics-todo)
      - [Program Structure (scoping, visibility, file structure, etc.)](#program-structure-scoping-visibility-file-structure-etc)
      - [Rule conflicts and scheduling](#rule-conflicts-and-scheduling)
      - [Testbenches](#testbenches)
      - [Synthesis / synthesize keyword](#synthesis--synthesize-keyword)
      - [Debugging / Common Error Messages](#debugging--common-error-messages)
      - [Display statements and other system tasks/functions](#display-statements-and-other-system-tasksfunctions)
      - [Provisos](#provisos)
      - [Recursion](#recursion)
